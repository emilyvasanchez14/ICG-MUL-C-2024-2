...
class Poligono {
    ...
    // Dibujar polígono en canvas (vectorizado)
    dibujarVectorizado(contexto) {
        contexto.beginPath();
...
const canvas = document.getElementById("miCanvasVector");
...
poligono.dibujarVectorizado(contexto);
document.getElementById("tipoPoligonoVector").innerText = "El polígono es " + poligono.verificarTipo();
